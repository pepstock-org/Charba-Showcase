...
final class Injector {
	...
	private static final String PIECE_LABEL_SCRIPT_ELEMENT_ID = "_PieceLabel_chartjs";
	...
	static void ensureInjected() {
		if (!injected) {
			...
			String source = res.pieceLabelJsSource().getText();
			// creates a script element
			ScriptElement scriptElement = Document.get().createScriptElement();
			// sets ID
			scriptElement.setId(PIECE_LABEL_SCRIPT_ELEMENT_ID);
