...
public class TreeMapUSPopulationCase extends BaseComposite {
	...
	interface ViewUiBinder extends UiBinder<Widget, TreeMapUSPopulationCase> {
	}
	...
	public TreeMapUSPopulationCase() {
		...
		dataset1.getLabels().setFonts(fi);

		FontItem fih = new FontItem();
		fih.setSize(15);
		fih.setFamily("Tahoma");
		dataset1.getLabels().setHoverFonts(fih);
