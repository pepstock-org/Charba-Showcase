...
public class LinearGradientRadarCase extends BaseComposite{
	
	private static ViewUiBinder uiBinder = GWT.create(ViewUiBinder.class);

	interface ViewUiBinder extends UiBinder<Widget, LinearGradientRadarCase> {
	}

	@UiField
	RadarChart chart;
	
	public LinearGradientRadarCase() {
		...
		chart.getOptions().getTitle().setText("Applying a linear gradient on radar chart dataset");
		
		RadarDataset dataset1 = chart.newDataset();
		dataset1.setLabel("dataset 1");
		
		Gradient gradient1  = UiGradient.TELEGRAM.createGradient(GradientType.LINEAR, GradientOrientation.TOP_DOWN, GradientScope.CHART);
