...
public class LineMyView extends BaseComposite{
	
	private static ViewUiBinder uiBinder = GWT.create(ViewUiBinder.class);

	interface ViewUiBinder extends UiBinder<Widget, LineMyView> {
	}
	...
	public LineMyView() {
		...
		LineMyDataset dataset1 = chart.newDataset();
		...
		LineMyDataset dataset2 = chart.newDataset();
	...
	protected void handleAddDataset(ClickEvent event) {
		...
		LineMyDataset dataset = chart.newDataset();
