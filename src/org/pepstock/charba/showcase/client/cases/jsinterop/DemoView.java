...
//		Defaults.get().getPlugins().register(new ChartBackgroundColor(HtmlColor.LIGHT_GREEN));
		
//		Defaults.get().getPlugins().register(new HtmlLegend());
		
//		HtmlLegendOptions defaultOptions = new HtmlLegendOptions();
//		defaultOptions.setMaximumLegendColumns(2);
//		defaultOptions.setLegendTextCallback(new LegendTextCallback() {
//			
//			@Override
...
//			}
//		});
//		Defaults.get().getGlobal().getPlugins().setOptions(HtmlLegend.ID, defaultOptions);
