...
import org.pepstock.charba.client.gwt.widgets.StackedHorizontalBarChartWidget;
...
public class StackedHorizontalBarCase extends BaseComposite {
	...
	interface ViewUiBinder extends UiBinder<Widget, StackedHorizontalBarCase> {
	}

	@UiField
	StackedHorizontalBarChartWidget chart;
