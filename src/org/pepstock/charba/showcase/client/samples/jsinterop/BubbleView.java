...
import org.pepstock.charba.client.jsinterop.BubbleChart;
 ...
 */
public class BubbleView extends BaseComposite{
	...
	interface ViewUiBinder extends UiBinder<Widget, BubbleView> {
	}
	...
	public BubbleView() {
		...
		chart.getOptions().getTitle().setText("Charba Bubble Chart");
