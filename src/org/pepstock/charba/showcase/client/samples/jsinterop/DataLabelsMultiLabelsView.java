...
public class DataLabelsMultiLabelsView extends BaseComposite{
	
	private static final int DATASET_NUMBER = 4;

	private static ViewUiBinder uiBinder = GWT.create(ViewUiBinder.class);

	interface ViewUiBinder extends UiBinder<Widget, DataLabelsMultiLabelsView> {
	}
	...
	public DataLabelsMultiLabelsView() {
