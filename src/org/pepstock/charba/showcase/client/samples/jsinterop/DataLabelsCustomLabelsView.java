...
import org.pepstock.charba.client.ext.datalabels.Font;
import org.pepstock.charba.client.ext.datalabels.FontCallback;
	...
	public DataLabelsCustomLabelsView() {
		...
		option.setFont(new FontCallback() {
			...
			public Font font(AbstractChart<?, ?> chart, Context context) {
				Font font = new Font();
				int width = chart.getNode().getWidth();
				font.setFontSize(width < 512 ? 12 : 14);
				return font;
			}
		});
